<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"/var/www/enterprise/public/../application/admin/view/text/project/type/edit.html";i:1637333534;s:62:"/var/www/enterprise/application/admin/view/layout/default.html";i:1633945806;s:59:"/var/www/enterprise/application/admin/view/common/meta.html";i:1633945806;s:61:"/var/www/enterprise/application/admin/view/common/script.html";i:1633945806;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select id="c-pid" data-rule="required" class="form-control selectpicker" name="row[pid]">
                ...
                <option data-type="<?php echo $vo['id']; ?>"  value="<?php echo $vo['id']; ?>" <?php if(in_array(($key), is_array($row['pid'])?$row['pid']:explode(',',$row['pid']))): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
