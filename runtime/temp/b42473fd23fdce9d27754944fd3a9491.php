<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"/var/www/enterprise/public/../application/admin/view/text/news/news_list/add.html";i:1637472140;s:62:"/var/www/enterprise/application/admin/view/layout/default.html";i:1633945806;s:59:"/var/www/enterprise/application/admin/view/common/meta.html";i:1633945806;s:61:"/var/www/enterprise/application/admin/view/common/script.html";i:1633945806;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <!-- <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-first_id" data-rule="required" data-source="first/index" class="form-control selectpage" name="row[first_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Image_type_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-image_type_id" data-rule="required" data-source="image/type/index" class="form-control selectpage" name="row[image_type_id]" type="text" value="">
        </div>
    </div> -->
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Entry_time'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-entry_time" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[entry_time]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[status]', [0=>__('Status 0'), 1=>__('Status 1')]); ?>
        </div>
    </div>
