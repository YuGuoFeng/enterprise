<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"/var/www/enterprise/public/../application/admin/view/text/honor/awards_list/edit.html";i:1637408438;s:62:"/var/www/enterprise/application/admin/view/layout/default.html";i:1633945806;s:59:"/var/www/enterprise/application/admin/view/common/meta.html";i:1633945806;s:61:"/var/www/enterprise/application/admin/view/common/script.html";i:1633945806;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-first_id" data-rule="required" data-source="text/honor/awards_type/index" class="form-control selectpage" name="row[first_id]" type="text" value="<?php echo htmlentities($row['first_id']); ?>">
        </div>
    </div>
    <!-- <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Image_type_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-image_type_id" data-rule="required" data-source="image/type/index" class="form-control selectpage" name="row[image_type_id]" type="text" value="<?php echo htmlentities($row['image_type_id']); ?>">
        </div>
    </div> -->
    <div class="form-group">
