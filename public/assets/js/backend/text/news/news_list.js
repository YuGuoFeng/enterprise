define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'text/news/news_list/index' + location.search,
                    add_url: 'text/news/news_list/add',
                    edit_url: 'text/news/news_list/edit',
                    del_url: 'text/news/news_list/del',
                    multi_url: 'text/news/news_list/multi',
                    import_url: 'text/news/news_list/import',
                    table: 'news_list',
                }
            });
